<template>
	<!--网点审核   点击网点提报的待审核数据  双击任一数据进入网点审核页面-->
			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="* 联系电话:">
						<el-input :disabled="true" v-model="ruleForm.networkTel" placeholder="请输入联系电话"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<!--网点基本信息 end-->
				...
				<el-row v-for="company in companys" :key="company.id">
					<el-col :span="8">
						<el-form-item label="名称:">
							<el-input :disabled="true" v-model="company.aroundFinanceName" placeholder="请输入公司名称"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="离店距离:">
							<el-input :disabled="true" @keyup.native="" v-model="company.aroundFinanceVlaue" placeholder="请输入公司距离">
			...
			<el-row>
				<el-col :span="16">
					<el-form-item label="* 注册地址">
						<el-checkbox-group :disabled="true" v-model="ruleForm.addAddr">
				...
				<el-col :span="8">
					<el-form-item label="* 邮政编码:">
						<el-input :disabled="true" :maxlength="6" v-model="ruleForm.zipCode" placeholder="请输入邮政编码"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
			...
			<el-dialog title="审核意见" :visible.sync="batchReview" :show-close="false">
				<el-form :model="batchForm" label-width="120px">
					<el-form-item label="* 审核结果">
						<el-radio-group v-model="batchForm.isAgree" @change="agreeChange">
	...
	export default {
		...
		methods: {
			...
			agreeChange(){
				...
				console.log(this.batchForm.isAgree)
				if(this.userRoleName == "市场部" && this.batchForm.isAgree == 2) {
